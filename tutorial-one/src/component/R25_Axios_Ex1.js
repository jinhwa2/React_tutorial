...
const Axios_Ex1 = () => {
  ...
  return (
    <>
      ...
      <br/>
      {data && <textarea row={20} col={80} value={JSON.stringify(data,null,2)} readOnly={true}/>}
...
<textarea 안에 Json 으로 가져온 값을 추가
 ...
 (data, null, 2)
 data = json으로 가져온 데이터
 null = 모두선택        String으로 어디서부터 어디까지 변환할 것인가? 에서 null 모든 속성을 선택 모두선택
