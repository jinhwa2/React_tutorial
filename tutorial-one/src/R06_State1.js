...
Hook 종류 = react 에서 어떤 동작이나 상태를 표현하거나 변경할 때 사용하는 기능들
 ...
 두 개 이상의 훅을 작성
 import React, {useState,useEffect,useContext,..넣고싶은기능 작성 } from 'react';
 ...
 */
  ...
  /*
    ...
    ES6(ECMScript 6 = JavaScript 문법 현재 가장 최신버전)
    const State예제1 = () => { 
  ...
  const State예제1 = () => { 
    ...
    // const [초기값, 벼경될값] = useState('처음에 들어갈 값이 무엇인지 작성');
    ...
    // 버튼을 클릭할 경우 동작할 함수(이벤트 핸들러) 기능 작성
     ...
     return (
        ...
        // 우리가 만드는 javascript 와 html,css 와 같은 코드들이 모두 들어갈 것이기 때문
